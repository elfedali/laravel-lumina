<form method="POST" action="{{ route('changes.locales.store') }}" id="formCreateLocale">
    @csrf
    <div class="modal-dialog" id="appLocaleModalDialog">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="form-floating">
                            <input type="text" name="address" id="locale_address" class="form-control"
                                placeholder="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg mb-3">
                            <div class="form-floating">
                                <input type="text" name="city" id="locale_city" class="form-control"
                                    placeholder="">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-lg mb-3">
                            <div class="form-floating">
                                <input type="tel" name="phone" id="locale_phone" class="form-control"
                                    placeholder="">
                        ...
                        <div class="col-lg mb-3">
                            <div class="form-floating">
                                <input type="tel" name="phone2" id="locale_phone2" class="form-control"
                                    placeholder="">
